                ...
                <div class="col-12">
                    <div class="mb-2">
                        ...
                        <div class="float-sm-right text-zero">
                            <a href="<?= RUTA_URL . "/Categoria/vRegistrar"?>" class="btn btn-primary btn-lg top-right-button mr-1">Nueva Categoria</a>
					...
					<div class="card d-flex flex-row mb-3">
                        <div class="d-flex flex-grow-1 min-width-zero">
                            ...
                            <div class="custom-control custom-checkbox pl-1 align-self-center pr-4">
								<a href="<?= RUTA_URL . "/Categoria/vModificar/".$categoria->id_categoria ?>" class="btn btn-warning mb-1">Modificar</a>
								<a href="<?= RUTA_URL . "/Categoria/vEliminar/".$categoria->id_categoria ?>" class="btn btn-danger mb-1">Eliminar</a>
                            </div>
                        </div>
					</div>
				<?php endforeach;?>
