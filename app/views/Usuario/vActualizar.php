...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-body">
                    <h6 class="mb-3">Actualizar Usuario</h6>
                    <form class="needs-validation" id="form_UsuarioActualizar" novalidate>
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control"
                                    ...
                                    placeholder="Usuario"
                                    value="<?= $data['Usuario']->usuario ?>" maxlength="25" required>
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control"
                                        name="Usuario[nombre]"
                                        placeholder="Nombre"
                                        value="<?= $data['Usuario']->nombre ?>" maxlength="35" required>
                                <div class="invalid-feedback">
                                    Campo Requerido
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" 
                                        ...
                                        value="<?= $data['Usuario']->apellidos ?>" maxlength="45" required>
                                <div class="invalid-feedback">
                                    Campo Requerido
                                </div>
                            </div>
                        ...
                        <button class="btn btn-primary" type="reset" onclick="document.location.href='<?= RUTA_URL ?>/Usuario/vLista';" >Cancelar</button>
                    </form>
                </div>
            </div>
        </div>
